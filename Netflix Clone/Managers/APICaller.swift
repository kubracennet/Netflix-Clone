...
struct Constants {
    ...
    static let YoutubeAPI_KEY = "AIzaSyCyuahLD2X-Z_Jx191adj2KQE6Vs1bqQHI" //Google developer hesabından oluşturup aldım api bağlantısı
    static let YoutubeBaseURL = "https://youtube.googleapis.com/youtube/v3/search?" //Youtube api içerisinden aldım kodu. Film adını q da belirtip uzantıyı kopyaladım.
}
